...
liste.forEach((ctry) => {
	execSync('curl -k --GET https://www.cia.gov/library/publications/resources/the-world-factbook/geos/'+ctry+'.html > ctry/'+ctry+'.html');
})
//console.log(liste.length)

//var cmd = execSync('curl -k --GET https://www.cia.gov/library/publications/resources/the-world-factbook/geos/af.html > af.h//tml');

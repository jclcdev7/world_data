...
liste.forEach((ctry) => {
	execSync('curl -k --GET https://www.cia.gov/library/publications/resources/the-world-factbook/graphics/locator/cam/'+ctry+'_large_locator.gif > locator/'+ctry.toUpperCase()+'.gif');
})

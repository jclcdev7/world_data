...
liste.forEach((ctry) => {
	execSync('curl -k --GET https://www.cia.gov/library/publications/resources/the-world-factbook/graphics/flags/large/'+ctry+'-lgflag.gif > flags/'+ctry.toUpperCase()+'.gif');
})
